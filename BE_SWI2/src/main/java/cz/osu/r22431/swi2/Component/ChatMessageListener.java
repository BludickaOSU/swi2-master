package cz.osu.r22431.swi2.Component;
...
public class ChatMessageListener {
    ...
    @Autowired
    public ChatMessageListener(@Qualifier("rabbitListenerContainerFactory") RabbitListenerContainerFactory<?> factory, SimpMessagingTemplate messagingTemplate) {
